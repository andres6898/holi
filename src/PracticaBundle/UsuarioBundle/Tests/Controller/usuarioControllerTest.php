...
namespace PracticaBundle\UsuarioBundle\Tests\Controller;
...
class usuarioControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'practicabundle_usuariobundle_usuario[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Update')->form(array(
            'practicabundle_usuariobundle_usuario[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
